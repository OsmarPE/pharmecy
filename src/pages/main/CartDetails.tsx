                    ...
                    <div className="grid gap-2 mt-2">
                        <article className="py-4 flex justify-between gap-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-sm text-gray-400">Medicamentos</h3>
                                    <p className="text-black font-medium text-lg">Paracetamol 255ml</p>
                                </div>
                            </div>
                            <div className="flex flex-col justify-between items-end">
                                <div className="flex items-center gap-1">
                                    <p className="font-medium text-xl">$100.00</p>
                                ...
                                <div className="flex items-center bg-white shadow-md shadow-black/5 rounded border border-black/5">
                                    <button className="size-8 grid place-items-center transition-opacity duration-300 hover:opacity-50">
                                        <Plus size={16} />
                                    </button>
